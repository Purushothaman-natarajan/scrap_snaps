...
The agent is a LangGraph state machine with 7 nodes:
...
**Flow:** Planner generates tasks → Discovery/Evidence/Media executes them → Verification scores quality → Coverage checks gaps → Planner decides next steps or finalizes.
...
The agent uses 10 tools for web interaction:
